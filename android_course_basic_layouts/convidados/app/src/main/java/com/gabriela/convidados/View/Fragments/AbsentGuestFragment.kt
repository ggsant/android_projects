...
class AbsentGuestFragment : Fragment() {
    ...
    private var _binding: FragmentAbsentGuestBinding? = null
    ...
    override fun onCreateView(
        ...
        val slideshowViewModel =
            ViewModelProvider(this).get(AbsentGuestViewModel::class.java)

        _binding = FragmentAbsentGuestBinding.inflate(inflater, container, false)
